...
<body>
    <div style="overflow: hidden; height: 100vh;">
        ...
        <div class="task_area">
            <div class="bg_task_area">
                <p style="margin-left: 5%;">Please, enter User ID to delete user account in your department.</p>
                <hr style="border-width:1px;width:90%;text-align:center">
                <!-- <form class="addEmpForm" action="delt_user_proc.php" method="post">
                    <label for="user_id">User ID</label>
                    <input type="text" name="user_id">

                    <input type="submit" value="Delete User"  style="color: white; margin-top: 15px">
                </form> -->
                <table style="margin-bottom: 30px; width: 90%; margin-left: 5%">
                    ...
                    <?php
                        ...
                        ?>
                                ...
                                <td><a href="delt_user_proc.php?user_id=<?php echo $row['user_id'] ?>"><input type="button" class="primary" value="Delete" style="background-color:red;color:white;cursor:pointer;height:35px;width:50px"></a></td>
                                </tr>
                            <?php
                            }
                            ?>
    ...
    <div id="popup3">
        Sorry! This user does not belong to your department!
    </div>
