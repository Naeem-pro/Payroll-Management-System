...
<body>
    <div style="overflow: hidden; height: 120vh;">
        <div class="header">
            <div class="logo">
        ...
        <div class="sidebar">
            <div class="bg_sidebar">
                ...
                <a href="../manager/assistant.php" style="margin-top:12px; font-size:25px; height: 22px; line-height:22px">Assistants</a>
                <a href="../manager/leftEmp.php" style="margin-top:12px; font-size:25px; height: 22px; line-height:20px">Resigners</a>
