    ...
    <div style="overflow: hidden; height: 100vh;">
        ...
        <div class="sidebar">
            <div class="bg_sidebar">
                ...
                <a href="../employee/dashboard.php"  style="margin-top:12px; font-size:25px; height: 22px; line-height:22px">Dashboard</a>
                <a href="../employee/profile.php" style="margin-top:12px; font-size:25px; height: 22px; line-height:22px">Profile</a>
                <a href="../employee/payroll.php" style="margin-top:12px; font-size:25px; height: 22px; line-height:22px">Payroll</a>
                <a href="../employee/message.php" style="margin-top:12px; font-size:25px; height: 22px; line-height:22px">Messages</a>
                <a href="../logout.php" style="margin-top:12px; font-size:25px; height: 22px; line-height:22px">Logout</a>
            </div>
        </div>
        <div class="task_area">
            <div class="bg_task_area">
                <p style="margin-left: 5%;">Please fill the following form if you want to leave our company.</p>
                <hr style="border-width:1px;width:90%;text-align:center">

                <form class="addEmpForm" action="leftCompany.php" method="post">
                    ...
                    <textarea name="description" id="" cols="50" rows="16" required></textarea>
                    <input type="submit" value="Submit Form"  style="color: white">
                </form>
            </div>
        </div>
    </div>
