    ...
    <div style="overflow: hidden; height: 100vh;">
        ...
        <div class="sidebar">
            <div class="bg_sidebar">
                ...
                <a href="../employee/left.php" style="margin-top:12px; font-size:25px; height: 22px; line-height:22px">Resign</a>
                <a href="../logout.php" style="margin-top:12px; font-size:25px; height: 22px; line-height:22px">Logout</a>
            </div>
        </div>
        <div class="task_area">
            <div class="bg_task_area">
                <p style="margin-left: 5%;" class="">Employee Profile</p>
                <hr style="border-width:1px;width:90%;text-align:center">
                <a href="download.php"><p 
                style="text-align: center;
                    float: right;
                    background-color: rgb(102, 231, 158);
