                ...
                <table>
                    ...
                    <?php
                        ...
                        ?>
                                ...
                                <td><a href="deleteEmpProc21.php?emp_id=<?php echo $row['emp_id'] ?>"><input type="button" class="primary"  value="Delete" style="background-color:red;color:white;cursor:pointer;height:35px;width:50px"></a></td>
                                </tr>
                            <?php
                                 $i++;
                                }
